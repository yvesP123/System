...
<html lang="en">
	<head>
		<title>Admin | View Umuhinzi</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Admin | View Umushoramali</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Admin</span>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">View/<span class="text-bold">Umushoramali</span></h5>
<%
...
String sql ="select id,name,address,city,gender,email,phone from umushoramali";
...
<td><a href="update-umushoramali.jsp?id=<%=resultSet.getString("id")%>">update</a>|<a href="delete_umushoramali.jsp?id=<%=resultSet.getString("id")%>">Delete</a></td>
</tr>
</tbody>
<%
}
