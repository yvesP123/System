...
<html lang="en">
	<head>
		<title>Umuhinzi | Edit Profile</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Umushoramali | Edit Profile</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>User </span>
...
String sql ="select * from umushoramali where id="+id;
...
<div class="form-group">
						<form role="form" name="edit" action="update-process1.jsp" method="post">
						
                                  			<input type="hidden" name="id" class="form-control" value="<%=resultSet.getString("id") %>">
                                  						</div>
...
<div class="form-group">
		...
		<input type="text" name="city" class="form-control" required="required"  value="<%=resultSet.getString("city") %>" >
														</div>
...
<div class="form-group">
					...
					<input type="email" name="uemail" class="form-control"  readonly="readonly"  value="<%=resultSet.getString("email") %>">
...
<div class="form-group">
					...
					<input type="email" name="phone" class="form-control"  readonly="readonly"  value="<%=resultSet.getString("phone") %>">
