...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Admin | View Contact</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Admin</span>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">View/<span class="text-bold">Contact</span></h5>
<%
...
<td><a href="https://accounts.google.com/ServiceLogin/signinchooser?service=mail&passive=1209600&osid=1&continue=https%3A%2F%2Fmail.google.com%2Fmail%2Fu%2F0%2F%3Ftab%3Dkm&followup=https%3A%2F%2Fmail.google.com%2Fmail%2Fu%2F0%2F%3Ftab%3Dkm&emr=1&flowName=GlifWebSignIn&flowEntry=ServiceLogin#inbox">Reply</a>|<a href="delete-contact.jsp?id=<%=resultSet.getString("id")%>">Delete</a></td>
</tr>
</tbody>
<%
}
