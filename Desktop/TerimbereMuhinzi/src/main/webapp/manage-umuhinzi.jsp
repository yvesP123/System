...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Admin | View Umuhinzi</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Admin</span>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">View/<span class="text-bold">Umuhinzi</span></h5>
<%
...
String sql ="select id,name,address,city,gender,email from patient ";
...
<td><a href="update-umuhinzi.jsp?id=<%=resultSet.getString("id")%>">update</a>|<a href="delete_umuhinzi.jsp?id=<%=resultSet.getString("id")%>">Delete</a></td>
</tr>
</tbody>
<%
}
